          ...
          <div id="panels_row" class="row m-0">
            <div id="conversations_panel" class=" col-5 chat-panel">
              ...
              <div id="conversations">
                <div class="row chat-row" aria-current="true">
                  <div class="col-2 profile-container">
                    <img alt="img" src="pictures/face1.png" />
                  </div>
                  <div class="col-10 d-flex">
                    <div class="row name-time-last-message-container">
                      ...
                      <div class="col-12 last_msg fw-lighter fst-italic">
                        ...
                        Sed enim nisi, euismod eget elit et, rutrum placerat
                        nunc. Vestibulum non ligula ex. Donec congue iaculis
                        consequat. Etiam dui risus, semper vel feugiat eu,
                        porttitor in tortor. Pellentesque vulputate mi velit, eu
                        mollis libero pharetra vel. Duis vitae massa nec sapien
                        fringilla ornare. Integer sed massa nec nunc condimentum
                        lacinia. Aenean malesuada nisi nec sem fringilla
                        tincidunt. Aenean volutpat elementum ante, facilisis
                        ultrices tortor semper sed. Integer sit amet purus vel
                        dui luctus suscipit. In rhoncus finibus luctus. Nulla
                ...
                <div class="row chat-row">
                  <div class="col-2 profile-container">
                    <img alt="img" src="pictures/face3.jpeg" />
                  </div>
                  <div class="col-10 d-flex">
                    <div class="row name-time-last-message-container">
                      <div class="col-7 contact_name fw-bold">
                ...
                <div class="row chat-row">
                  <div class="col-2 profile-container">
                    <img alt="img" src="pictures/face4.jpg" />
                  </div>
                  <div class="col-10 d-flex">
                    <div class="row name-time-last-message-container">
                      <div class="col-7 contact_name fw-bold">
                ...
                <div class="row chat-row">
                  <div class="col-2 profile-container">
                    <img alt="img" src="pictures/face5.jpeg" />
                  </div>
                  <div class="col-10 d-flex">
                    <div class="row name-time-last-message-container">
                      <div class="col-7 contact_name fw-bold">
                ...
                <div class="row chat-row">
                  <div class="col-2 profile-container">
                    <img alt="img" src="pictures/face6.jpeg" />
                  </div>
                  <div class="col-10 d-flex">
                    <div class="row name-time-last-message-container">
                      <div class="col-7 contact_name fw-bold">
                ...
                <div class="row chat-row">
                  <div class="col-2 profile-container">
                    <img alt="img" src="pictures/face7.jpeg" />
                  </div>
                  <div class="col-10 d-flex">
                    <div class="row name-time-last-message-container">
                      <div class="col-7 contact_name fw-bold">
                ...
                <div class="row chat-row">
                  <div class="col-2 profile-container">
                    <img alt="img" src="pictures/face8.jpeg" />
                  </div>
                  <div class="col-10 d-flex">
                    <div class="row name-time-last-message-container">
                      <div class="col-7 contact_name fw-bold">
                ...
                <div class="row chat-row">
                  <div class="col-2 profile-container">
                    <img alt="img" src="pictures/face9.jpeg" />
                  </div>
                  <div class="col-10 d-flex">
                    <div class="row name-time-last-message-container">
                      <div class="col-7 contact_name fw-bold">
                ...
                <div class="row chat-row">
                  <div class="col-2 profile-container">
                    <img alt="img" src="pictures/face10.jpeg" />
                  </div>
                  <div class="col-10 d-flex">
                    <div class="row name-time-last-message-container">
                      <div class="col-7 contact_name fw-bold">
                ...
                <div class="row chat-row">
                  <div class="col-2 profile-container">
                    <img alt="img" src="pictures/face11.jpeg" />
                  </div>
                  <div class="col-10 d-flex">
                    <div class="row name-time-last-message-container">
                      <div class="col-7 contact_name fw-bold">
                ...
                <div class="row chat-row">
                  <div class="col-2 profile-container">
                    <img alt="img" src="pictures/face12.jpeg" />
                  </div>
                  <div class="col-10 d-flex">
                    <div class="row name-time-last-message-container">
                      <div class="col-7 contact_name fw-bold">
